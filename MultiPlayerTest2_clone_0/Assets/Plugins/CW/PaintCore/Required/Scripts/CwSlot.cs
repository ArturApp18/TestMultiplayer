...
namespace PaintCore
{
	...
	{
		private T GetComponentInParentLegacy<T>(Component component) where T : Component
		{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			var model = component != null ? GetComponentInParentLegacy<CwModel>(component) : null;
			var missing   = true;
